  ...
  <div class="chat-container">
    ...
    <div class="chat-main" ref="scrollView">
      <div class="message-list" ref="messageList">
        <div v-if="history.loading" class="history-loading">
          <img src="/src/assets/images/pending.gif"/>
        </div>
                ...
                <div class="message-payload">
                  ...
                  <a v-if="message.type === 'file'" :href="message.payload.url" target="_blank" download="download">
                    <div class="content-file" title="点击下载">
                      ...
                      <img class="file-img" src="/src/assets/images/file-icon.png"/>
                    </div>
                  </a>
    ...
    <div class="chat-footer">
      <div class="action-delete" v-if="messageSelector.visible">
        <img class="delete-btn" src="/src//assets/images/delete.png" @click="deleteMultipleMessages"/>
        <div>删除</div>
      </div>
...
<style scoped>
  ...
  .pending {
    background: url("/src/assets/images/pending.gif") no-repeat center;
  ...
  .send-fail {
    background: url("/src/assets/images/failed.png") no-repeat center;
  ...
  .content-audio .audio-facade-bg {
    background: url("/src/assets/images/voice.png") no-repeat center;
    background-size: 15px;
    width: 20px;
  }

  .content-audio .audio-facade-bg.play-icon {
    background: url("/src/assets/images/play.gif") no-repeat center;

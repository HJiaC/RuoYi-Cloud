...
insert into sys_menu values('106',  '参数设置',       '1',   '7', 'com.can.config',     'system/com.can.config/index',               '', 1, 0, 'C', '0', '0', 'system:com.can.config:list',      'edit',          'admin', sysdate(), '', null, '参数设置菜单');
...
-- 参数设置按钮
insert into sys_menu values('1030', '参数查询', '106', '1', '#', '', '', 1, 0, 'F', '0', '0', 'system:com.can.config:query',        '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1031', '参数新增', '106', '2', '#', '', '', 1, 0, 'F', '0', '0', 'system:com.can.config:add',          '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1032', '参数修改', '106', '3', '#', '', '', 1, 0, 'F', '0', '0', 'system:com.can.config:edit',         '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1033', '参数删除', '106', '4', '#', '', '', 1, 0, 'F', '0', '0', 'system:com.can.config:remove',       '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1034', '参数导出', '106', '5', '#', '', '', 1, 0, 'F', '0', '0', 'system:com.can.config:export',       '#', 'admin', sysdate(), '', null, '');
-- 通知公告按钮
